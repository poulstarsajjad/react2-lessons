...
function CardPopular() {
  ...
  return (
    <div className="flex justify-between items-center">
        {
        cards.map((card)=>(
            <div key={card.url} style={{backgroundImage: `url(${card.url})`}} className="bg-cover bg-center shadow-md shadow-cyan-600 w-75 h-[27rem] mb-25 rounded-lg hover:transform transition-[0.4] hover:scale-95">
                <div className="pt-[20rem] text-white">
