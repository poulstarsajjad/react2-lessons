    ...
    <div>
        ...
        <div className="bg-[url('/background.jpg')] bg-cover bg-center bg-transparent w-full h-[40rem] mb-30 flex justify-between items-center px-50 gap-10">
            ...
            <div className="relative">
                ...
                <span className="absolute top-[10.5rem] left-[17rem] cursor-pointer">
        ...
        <div className="flex justify-between items-center gap-15 mx-50 mb-50">
            ...
            <div>
                ...
                <button className="border-2 border-gray-400 px-10 py-4 font-medium hover:bg-gray-400 hover:text-white cursor-pointer">Explore Now</button>
            </div>
        </div>
